        ...
        solutionList: [
          {
            ...
            description:
              "디자이너와 협업하여 디자인 토큰의 카테고라이징을 개발자와 디자이너 모두가 공감할 수 있게 체계화했습니다. 색상, 타이포그래피, 간격, 그림자 등의 디자인 요소를 명확히 분류하고, 테마 변경과 다크모드 지원이 용이하도록 설계했습니다.",
          },
        ],
        achievementList: [
          {
    ...
    structuralContributions: [
      {
        ...
        problemDescription:
          "사용자가 텍스트 내에서 원하는 영역을 직접 선택하고, 그 선택 영역에 대해 컨텍스트 메뉴를 통해 라벨 값을 저장할 수 있는 기능이 필요했습니다. 직관적이지 않아 사용자 만족도가 낮았습니다.",
        categories: ["사용자경험"],
        solutionList: [
          {
