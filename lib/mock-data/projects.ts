  ...
  },
  {
    ...
    structuralContributions: [
      ...
      },
      {
        title: "커서 기반 무한 스크롤과 가상 스크롤 적용",
        problemDescription:
          "대용량 알람 데이터를 한 번에 렌더링하면서 UI가 느려지고 스크롤이 버벅거리는 문제가 발생했습니다. 또한 최신 알람이 도착해도 사용자가 인지하기 어려워 중요한 알람을 놓치는 경우가 빈번했습니다. 특히 1,000개 이상의 알람이 쌓이면 페이지 로딩 자체가 불가능한 상황이었습니다.",
        categories: ["성능최적화", "사용자경험"],
        solutionList: [
          {
            title: "커서 기반 무한 스크롤과 가상 스크롤 적용",
