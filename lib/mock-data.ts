...
export const mockPortfolioData: PortfolioData = {
  personalInfo: {
    ...
    location: "서울, 대한민국",
    experience: 4,
    bio: "저는 사용자와 개발자가 모두 기억할 만한 경험을 만들어가는 데 집중하는 프론트엔드 개발자입니다.\n\n사용자가 의식하지 않아도 편안함을 느낄 수 있도록, 적절한 로딩 시간, 예측 가능한 인터랙션, 그리고 미묘하지만 의미 있는 시각적 디테일 등 '보이지 않는 UX'를 세심하게 설계해왔습니다. 이러한 경험은 단순히 기능을 사용하는 것이 아니라, 사용자가 제품과 상호작용하며 자연스럽게 느끼는 만족과 신뢰로 이어진다고 생각합니다.\n\n동시에 저는 개발자 경험(DX)에도 많은 관심을 기울입니다. 코드 구조화, 반복 작업의 자동화, 협업 환경 개선 등을 통해 팀이 보다 효율적이고 즐겁게 일할 수 있는 기반을 마련함으로써, 개발 과정 자체가 성장과 학습의 경험이 될 수 있도록 노력했습니다.\n\n이처럼 사용자와 팀을 위한 작은 경험들을 하나씩 쌓아가는 과정이, 결국에는 제품과 조직 모두에 긍정적인 기억으로 남고 장기적인 가치를 만들어낸다고 믿습니다.",
  },
  introduction: {
    mindset: [
      {
      ...
      structuralContributions: [
        {
          ...
          achievementList: [
            {
              text: "공통 패키지를 기반으로 3개 앱 개발, 신규 프로젝트 개발 기간 50% 단축",
              category: "개발효율성",
            },
            {
              text: "모듈화 구조로 유지보수성과 확장성 대폭 향상",
              category: "개발효율성",
            },
            { text: "코드 중복 제거 및 기술 부채 해소", category: "품질향상" },
          ],
          media: {
            url: "/placeholder.svg?height=300&width=600&text=NX+Monorepo+아키텍처+구조도",
            alt: "NX Monorepo 아키텍처 구조도",
            caption: "NX Monorepo와 Feature-Sliced Design을 적용한 프로젝트 구조",
          },
        },
        {
        ...
        },
        {
          ...
          media: {
            url: "/placeholder.svg?height=400&width=700&text=실시간+알람+UI+최적화",
        ...
        },
        {
          ...
          achievementList: [
            ...
            {
              text: "'결함 찾기' 버튼 제안 및 구현으로 검수 정확도와 효율성 크게 향상",
              category: "사용자경험",
            },
            {
    ...
    },
    {
      ...
      structuralContributions: [
        ...
        },
        {
          ...
          media: {
            url: "/placeholder.svg?height=350&width=650&text=다중+채널+모니터링+레이아웃",
            alt: "다중 채널 모니터링 레이아웃",
            caption: "드래그 앤 드롭으로 조정 가능한 다중 채널 모니터링 인터페이스",
          },
        },
      ],
      ...
      structuralContributions: [
        ...
        },
        {
          ...
          achievementList: [
            ...
            {
              text: "직관적 라벨링 UI 제공으로, 작업 시간 평균 40% 단축하여 전체 프로젝트 효율성 향상",
              category: "사용자경험",
            },
          ],
        },
  ...
  certifications: [
    {
      name: "UX 전문가 인증서 취득 예정",
      issuer: "Google - 관련 강의 수강 중",
      date: "2025년 상반기 예정",
      description:
  ...
  articles: [
    {
      ...
      category: "개발 문화",
      tags: ["코드리뷰", "PR", "템플릿", "협업"],
      notionUrl: "https://notion.so/pr-template",
...
좋은 개발 문화는 작은 도구의 개선에서 시작된다는 것을 다시 한번 확인할 수 있었습니다.`,
    },
    {
      ...
      notionUrl: "https://notion.so/chrome-bookmarks",
...
하루에 몇 분씩 절약되는 시간이 1년이면 상당한 시간이 됩니다. 이런 작은 개선들이 모여 큰 생산성 향상을 만들어냅니다.`,
    },
    {
      ...
      notionUrl: "https://notion.so/workflow-improvement",
      content: `# 업무 프로세스 개선
...
작은 개선이라도 지속적으로 실행하면 큰 변화를 만들 수 있다는 것을 경험했습니다.`,
    },
    {
      ...
      notionUrl: "https://notion.so/fe-process-improvement",
...
지속적인 개선과 팀원들의 적극적인 참여가 성공의 핵심이었습니다.`,
    },
    {
      ...
      notionUrl: "https://notion.so/outlook-automation",
