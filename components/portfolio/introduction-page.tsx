                        ...
                        {companyProjects.map((proj) => (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <p className="text-xs font-medium text-gray-900 leading-tight flex-1">
                                {proj.title}
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="space-y-4">
                      ...
                      {selectedProject.structuralContributions?.map(
                        (contribution, idx) => (
                          <div
                            key={idx}
                            className="border-l-2 border-lime-400 pl-4"
                          >
              ...
              <CardContent className="p-6">
                ...
                {education.map((edu, index) => (
                  <div key={index} className="border-l-2 border-gray-200 pl-4">
                    ...
                    {edu.gpa && (
                      <p className="text-xs text-gray-500">학점: {edu.gpa}</p>
                    )}
                    {edu.description && (
                ...
                >
                  <Card className="border-gray-200 h-full hover:shadow-lg transition-all hover:border-lime-300">
                    <CardContent className="p-4">
                      <Badge
                        variant="secondary"
                        className="text-xs mb-2 bg-lime-100 text-lime-700"
                      >
                        {article.category}
                      </Badge>
