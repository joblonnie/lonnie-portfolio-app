        ...
        <article className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <div className="space-y-6">
              ...
              {project.structuralContributions?.map((contribution, index) => (
                <div key={index}>
                  ...
                  {contribution.solutionList?.map(({ title, description }) => {
                    return (
                      <div>
                        <div className="flex items-center gap-3 mb-3">
                        ...
                        <p className="text-gray-600 dark:tet-gray-400 leading-relaxed mb-6">
                          {description}
                        </p>
                      </div>
                    );
          ...
          {project.projectPhases && project.projectPhases.length > 0 && (
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                프로젝트를 단계별로 진행하면서 달성한 주요 성과와 결과물을
                소개합니다.
              </p>
              ...
              <div className="space-y-6">
                {project.projectPhases.map((phase, index) => (
                  <Card
                    key={index}
                    className="bg-gray-50 dark:bg-gray-800/50 border-0 shadow-sm"
                  >
                    <CardContent className="p-6 card-content space-y-4">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                        {phase.phase}
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              프로젝트를 통해 달성한 주요 성과와 개발 과정에서 얻은 인사이트를
              정리합니다.
            </p>
