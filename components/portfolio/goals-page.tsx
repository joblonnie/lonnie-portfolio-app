    ...
    <div className="min-h-screen bg-background p-4 sm:p-6 lg:p-8 relative">
      <div className="max-w-6xl mx-auto space-y-8 lg:space-y-12">
        ...
        <AnimatedElement animation="slideUp" delay={0} duration={200} className="text-center space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-lime-600 to-coral-600 bg-clip-text text-transparent">
            목표 & 비전
          </h1>
      ...
      {showScrollTop && (
        <Button
          onClick={scrollToTop}
          size="icon"
          className="fixed bottom-8 right-8 z-50 w-12 h-12 rounded-full bg-lime-500 hover:bg-lime-600 text-white shadow-lg hover:shadow-xl transition-transform duration-300 hover:scale-110"
        >
